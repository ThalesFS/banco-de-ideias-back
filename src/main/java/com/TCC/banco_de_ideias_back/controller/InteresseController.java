...
public class InteresseController {
    ...
    public InteresseController(InteresseService interesseService, AlunoRepository alunoRepository, InteresseRepository interesseRepository) {
    ...
    public List<Interesse> listarPorAluno(@PathVariable Long alunoId) {
        return interesseService.listarPorAluno(alunoId);
    }
    // ================================================ ALUNO ================================================
